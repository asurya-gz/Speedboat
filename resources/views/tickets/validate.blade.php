...
@section('content')
    <style>
        ...
        /* GREEN CHECK */
        #debug-library:contains("✅"),
        #debug-camera:contains("✅") {
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
                ...
                <div class="p-6">
                    ...
                    <div class="text-center mb-4" id="scan-button-container">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">Klik untuk mengaktifkan kamera dan mulai
                            scan tiket</p>
                    </div>
                    ...
                    <div class="mb-4" id="camera-container" style="display: none;">
                        ...
                        <div id="qr-reader"
                            style="width: 100%; min-height: 300px; border: 2px dashed #e5e7eb; border-radius: 8px; background: #f9fafb;">
                        </div>
                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
                        ...
                        <div class="flex space-x-2">
                            <input type="text" id="manual-qr-input"
                                class="form-input flex-1 text-gray-900 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400"
                        ...
                        <div class="mt-3 p-2 bg-gray-100 dark:bg-gray-700 rounded text-xs" id="debug-info">
                            ...
                            <strong>Protocol:</strong> <span
                                id="debug-protocol"><?= isset($_SERVER['HTTPS']) ? 'HTTPS' : 'HTTP' ?></span>
                        </div>
                    </div>
    ...
    `;
            ...
            try {
                ...
                const cameraTimeout = setTimeout(() => {
                    if (!isScanning) {
                        showCameraError(
                            'Gagal mengakses kamera. Pastikan kamera tidak digunakan aplikasi lain dan browser memiliki izin akses kamera.'
                            );
                    }
    ...
    `;
        ...
        function onScanFailure(error) {
            ...
            if (error && typeof error === 'string' && (
                ...
                isScanning = false;
                showCameraError(
                    'Akses kamera ditolak atau tidak dapat mengakses kamera. Pastikan memberikan izin akses kamera pada browser dan kamera tidak sedang digunakan aplikasi lain.'
                    );
                return;
            }
