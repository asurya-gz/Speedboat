...
<body class="bg-gray-50 dark:bg-gray-900 font-sans antialiased transition-colors duration-200">
    <div class="flex min-h-screen">
        <!-- Sidebar -->
        <aside
            class="fixed inset-y-0 left-0 z-50 w-64 sidebar-gradient transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0"
            id="sidebar">
            <div class="flex flex-col h-full">
                <!-- Logo -->
                <div
                    class="flex items-center justify-center h-16 px-4 border-b border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-800">
                    <div class="text-center">
                        <h4 class="text-xl font-bold text-gray-800 dark:text-white flex items-center justify-center">
                            <img src="{{ asset('image/logo.png') }}" alt="Speedboat Logo"
                ...
                <nav class="flex-1 px-4 py-6 space-y-2">
                    ...
                    <div class="relative" x-data="{ open: {{ request()->routeIs('dashboard') || request()->routeIs('analytics') ? 'true' : 'false' }} }">
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-200"
                            ...
                            x-transition:leave-end="opacity-0 transform -translate-y-2" class="ml-8 mt-2 space-y-1">
                            <a href="{{ route('dashboard') }}"
                                ...
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M8 5a2 2 0 012-2h2a2 2 0 012 2v3H8V5z"></path>
                                </svg>
                                Dashboard
                            </a>
                    ...
                    @auth
                        @if (Auth::user()->isAdmin() || Auth::user()->isKasir())
                            ...
                            <a href="{{ route('speedboats.index') }}"
                                ...
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M8 13v-1m4 1v-3m4 3V8M8 21l4-7 4 7M3 4h18M4 4h16v4a1 1 0 01-1 1H5a1 1 0 01-1-1V4z">
                                    </path>
                                </svg>
                                Speedboat
                            </a>
                                ...
                                <button @click="open = !open"
                                    ...
                                    <div class="flex items-center">
                                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h4M4 8h4m0 0V4m0 4h4m0 0V4m0 4v4">
                                            </path>
                                        </svg>
                                        QR
                                    </div>
            ...
            <div class="px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="mt-4 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg"
                        ...
                        <div class="flex">
                            <div class="flex-shrink-0">
                                <svg class="w-5 h-5 text-green-400 dark:text-green-300" fill="currentColor"
                                    viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                            ...
                            <div class="ml-auto pl-3">
                                <button type="button"
                                    class="inline-flex text-green-400 dark:text-green-300 hover:text-green-600 dark:hover:text-green-100"
                ...
                @if ($errors->any())
                    <div class="mt-4 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg"
                        ...
                        <div class="flex">
                            <div class="flex-shrink-0">
                                <svg class="w-5 h-5 text-red-400 dark:text-red-300" fill="currentColor"
                                    viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                            ...
                            <div class="ml-auto pl-3">
                                <button type="button"
                                    class="inline-flex text-red-400 dark:text-red-300 hover:text-red-600 dark:hover:text-red-100"
                                    onclick="this.parentElement.parentElement.parentElement.remove()">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                            d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
    ...
    <div id="changePasswordModal"
        class="fixed inset-0 bg-gray-900 bg-opacity-50 backdrop-blur-sm hidden z-50 transition-opacity duration-300">
                ...
                <form id="changePasswordForm" onsubmit="submitChangePassword(event)">
                    <div class="px-6 py-4 space-y-4">
                        <div>
                            ...
                            <div class="change-password-error text-red-500 text-xs mt-1"
                        ...
                        <div>
                            ...
                            <div class="change-password-error text-red-500 text-xs mt-1" data-field="new_password">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="change-password-error text-red-500 text-xs mt-1"
                                data-field="confirm_password"></div>
                        </div>
                    </div>
                    ...
                    <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700 flex justify-end space-x-3 rounded-b-xl">
                        ...
                        <button type="submit" id="changePasswordBtn"
                            ...
                            <svg id="changePasswordLoading" class="hidden animate-spin -ml-1 mr-2 h-4 w-4 inline"
