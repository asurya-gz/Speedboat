                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" 
                                   ...
                                   autocomplete="off">
                            <input type="hidden" id="speedboat_id" name="speedboat_id" value="{{ old('speedboat_id', $schedule->speedboat_id) }}" required>
                        ...
                        @error('speedboat_id')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                        <input type="hidden" id="name" name="name" value="{{ old('name', $schedule->name) }}">
                    </div>
