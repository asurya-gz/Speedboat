...
<div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Destinasi</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ \App\Models\Destination::count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ \App\Models\Schedule::count() }}</p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm">
        ...
        <div class="p-6">
            @php
                $recentSchedules = \App\Models\Schedule::with('destination')->latest()->limit(5)->get();
            @endphp
            ...
            @if($recentSchedules->count() > 0)
                <div class="space-y-4">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex-shrink-0">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $schedule->is_active ? 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-300' : 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300' }}">
            ...
            @else
                <div class="text-center py-8">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Mulai dengan menambahkan jadwal baru</p>
                </div>
            @endif
        </div>
    </div>
